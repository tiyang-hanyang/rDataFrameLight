...
void JetFlavourReader::analyze(const edm::Event &iEvent, const edm::EventSetup &iSetup)
{
    ...
    std::vector<float> bjetMass;
    std::vector<float> bjetPNetScore;
    // std::vector<float> leadingNonBjetPt;
    // std::vector<float> leadingNonBjetEta;
    // std::vector<float> leadingNonBjetPhi;
    // std::vector<float> leadingNonBjetMass;
    // std::vector<float> leadingNonBjetPNetScore;
    int jetMultiplicity(0);
    float totalJetPt(0.0);
    float totalBTagPt(0.0);
    ...
    for (const auto &jet : *jets)
    {
        ...
        bjetMass.push_back(jet.mass());
        bjetPNetScore.push_back(pnetBtagValue);
    ...
    // enlarged format
    storedInfo.push_back(jetMultiplicity);
    storedInfo.push_back(bjetMultiplicity);
    storedInfo.push_back(bjetPt[0]);
    storedInfo.push_back(bjetEta[0]);
    storedInfo.push_back(bjetPhi[0]);
    storedInfo.push_back(bjetMass[0]);
    storedInfo.push_back(bjetPNetScore[0]);
    storedInfo.push_back(bjetPt[1]);
    storedInfo.push_back(bjetEta[1]);
    storedInfo.push_back(bjetPhi[1]);
    storedInfo.push_back(bjetMass[1]);
    storedInfo.push_back(bjetPNetScore[1]);
    storedInfo.push_back(bjetPt[2]);
    storedInfo.push_back(bjetEta[2]);
    storedInfo.push_back(bjetPhi[2]);
    storedInfo.push_back(bjetMass[2]);
    storedInfo.push_back(bjetPNetScore[2]);
    storedInfo.push_back(bjetPt[3]);
    storedInfo.push_back(bjetEta[3]);
    storedInfo.push_back(bjetPhi[3]);
    storedInfo.push_back(bjetMass[3]);
    storedInfo.push_back(bjetPNetScore[3]);
    storedInfo.insert(storedInfo.end(), leadingBjetsDR.begin(), leadingBjetsDR.end());
    storedInfo.push_back(totalJetPt);
    storedInfo.push_back(totalBTagPt);
    storedInfo.push_back(bjetAssignmentLabel);
    storedInfo.push_back(passDimuon);
    storedInfo.push_back(passSameSign);
...
void JetFlavourReader::beginJob()
{
    ...
    outFile_ << "NJets,NBJet,b1pt,b1eta,b1phi,b1mass,b1PNet,b2pt,b2eta,b2phi,b2mass,b2PNet,b3pt,b3eta,b3phi,b3mass,b3PNet,b4pt,b4eta,b4phi,b4mass,b4PNet,b12dr,b13dr,b14dr,b23dr,b24dr,b34dr,totalJetPt,totalBJetPt,assignmentlabel,passdimuon,passSS" << std::endl;
}
