...
class RunIII2024Summer24NanoAODv15_job(GeneralJob):
    def __init__(self):
        ...
        self.fileJson = {
            "RunIII2024Summer24NanoAODv15": "../../../json/samples/special_relax_miniisolation/RunIII2024Summer24NanoAODv15_special_relax_miniIso_corr_preTTbar.json",
        }

        for (era, fPath) in self.fileJson.items():
            self.fileJson[era] = os.path.abspath(os.path.join(here, fPath))

        self.outDir = "/home/tiyang/public/AR_special_relax_miniIsolation_0128_ttbar_overlapping_removal/"
