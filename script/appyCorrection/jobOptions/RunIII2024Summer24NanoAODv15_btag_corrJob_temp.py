...
class RunIII2024Summer24NanoAODv15_job(GeneralJob):
    def __init__(self):
        ...
        self.fileJson = {
            "RunIII2024Summer24NanoAODv15": "../../../json/samples/FourJet_NanoAOD/RunIII2024Summer24NanoAODv15_fourJet_temp.json",
        }
        for (era, fPath) in self.fileJson.items():
            self.fileJson[era] = os.path.abspath(os.path.join(here, fPath))

        self.outDir = "/home/tiyang/public/SR_medium_muon_0127_fourJet_btag_corrected/"
