...
class RunIII2024Summer24NanoAODv15_job(GeneralJob):
    def __init__(self):
        ...
        self.fileJson = {
            "RunIII2024Summer24NanoAODv15": "../../../json/samples/applicationRegion/RunIII2024Summer24NanoAODv15_fullFakeableSel_pre_ttbar_removal.json",
        }
        for (era, fPath) in self.fileJson.items():
            self.fileJson[era] = os.path.abspath(os.path.join(here, fPath))

        self.outDir = "/home/tiyang/public/AR_0204_ttbar_overlapping_removal/"
